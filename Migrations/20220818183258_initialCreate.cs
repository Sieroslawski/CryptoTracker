    ...
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CryptoUsers", x => x.userID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    coinValue = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CryptoUserTransactions", x => new { x.userID, x.transactionID });
                    table.ForeignKey(
                        name: "FK_CryptoUserTransactions_CryptoUsers_userID",
                        column: x => x.userID,
                        principalTable: "CryptoUsers",
                        principalColumn: "userID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CryptoUserTransactions_Transactions_transactionID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CryptoUserTransactions_transactionID",
